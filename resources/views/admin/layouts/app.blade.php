...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="home" class="logo">
            ...
            <span class="logo-lg">Advertising</span>
        </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="{{url('ad/all')}}"><i class="fa fa-book"></i> <span>Advertising</span></a></li>
        <li><a href="{{url('time/index')}}"><i class="fa fa-flag"></i> <span>Time</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
